...
add_action('init', 'smde_init_cpt');
add_action('admin_menu', 'smde_reorganize_dash', 99, 0);
add_action( 'admin_enqueue_scripts', 'smde_enqueue_script');
add_action( 'post_updated_messages', 'smde_change_custom_post_mess');